...
import {
  employeeTemplate,
  employeeContainerTemplate,
} from "./employeeTemplates";
...
const employee = function (data) {
  ...
  const onEdit = (e) => {
    switch (e.target.id) {
      case "delete":
        eventManager.handle.dispatchEvent(
      ...
      case "edit":
        ...
        const payload = {
          ...
          firstname: e.currentTarget.parentElement
            .querySelector("#firstname")
            .value.trim(),
          lastname: e.currentTarget.parentElement
            .querySelector("#lastname")
            .value.trim(),
          salary: e.currentTarget.parentElement
            .querySelector("#salary")
            .value.trim(),
          vacation: e.currentTarget.parentElement
            .querySelector("#vacation")
            .value.trim(),
        };
        // Snippet 2.
        eventManager.handle.dispatchEvent(
